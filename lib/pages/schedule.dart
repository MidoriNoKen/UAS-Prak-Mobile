              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(
                      "Leaderboards", style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromRGBO(60, 53, 134, 1), fontSize: 20,),
                    ),
                  ),
                  Container(
                    height: 174,
                          ...
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: ConstrainedBox(
                                ...
                                child: Column(
                                    children: [
                                      Container(margin: EdgeInsets.only(bottom: 10),child: Text("FIFA World Cup", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16),)),
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            Row(
                                              children: [
                                                Container(
                                                    child: Text("1", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 16),),
                                                ...
                                                Container(
                                                  margin: EdgeInsets.only(left: 16, right: 16),
                                                    child: Text("Argentina", style: TextStyle(color: Colors.white70, fontSize: 16, fontWeight: FontWeight.w200),)
                                                ),
                                                Container(
                                                  child: Card(
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text("100", style: TextStyle(fontSize: 10, color: Color.fromRGBO(60, 53, 134, 1)),textAlign: TextAlign.center,
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                                        ...
                                        child: Row(
                                          children: [
                                            Row(
                                              children: [
                                                Container(
                                                  child: Text("2", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 16),),
                                                  margin: EdgeInsets.only(right: 16),
                                                ),
                                                Container(
                                                  child: Image.network(
                                                ...
                                                Container(
                                                  child: Card(
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(2.0),
                                                        child: Text("80", style: TextStyle(fontSize: 10, color: Color.fromRGBO(60, 53, 134, 1)),textAlign: TextAlign.center,
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                                        ...
                                        child: Row(
                                          children: [
                                            Row(
                                              children: [
                                                Container(
                                                  child: Text("3", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 16),),
                                                  margin: EdgeInsets.only(right: 16),
                                                ),
                                                Container(
                                                  child: Image.network(
                                                ...
                                                Container(
                                                  child: Card(
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(2.0),
                                                        child: Text("70", style: TextStyle(fontSize: 10, color: Color.fromRGBO(60, 53, 134, 1)),textAlign: TextAlign.center,
                                                        ),
                                                      ),
                                                    ),
                                                  ),
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.only(left: 10),
                    child: Text(
                      "Match Schedule", style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromRGBO(60, 53, 134, 1), fontSize: 20,),
                    ),
                  ),
                  Container(
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(4.0),
                                                            child: Text("24 Dec", style: TextStyle(fontSize: 10, color: Colors.white70),textAlign: TextAlign.center,
                                                            ),
                                                          ),
                                                        )
                                                      ],
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: Padding(
                                                            padding: const EdgeInsets.all(4.0),
                                                            child: Text("25 Dec", style: TextStyle(fontSize: 10, color: Colors.white70),textAlign: TextAlign.center,
                                                            ),
                                                          ),
                                                        )
                                                      ],
